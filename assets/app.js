...
var $author$project$Page$Search$FindMods = {$: 'FindMods'};
		...
		switch (msg.$) {
			...
			case 'SetSearchTerm':
				...
				return _Utils_Tuple2(
					...
					A3($andrewMacmurray$elm_delay$Delay$after, 250, $andrewMacmurray$elm_delay$Delay$Millisecond, $author$project$Page$Search$FindMods));
			default:
				return _Utils_Tuple2(
					model,
					$author$project$Page$Search$findMods(model.searchTerm));
		}
	});
...
var $author$project$Page$Search$viewMod = function (mod) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$text(mod.name)
			]));
};
var $author$project$Page$Search$viewKeyedMod = function (mod) {
	return _Utils_Tuple2(
		mod.id,
		$author$project$Page$Search$viewMod(mod));
};
var $author$project$Page$Search$viewMods = function (mods) {
	return A2(
		...
		A2($elm$core$List$map, $author$project$Page$Search$viewKeyedMod, mods));
};
var $author$project$Page$Search$viewContent = function (results) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
			...
			switch (results.$) {
				case 'Loading':
					return A2(
						...
						{description: 'Loading icon', src: './assets/loading.svg'});
				case 'Success':
					var mods = results.a;
					return $author$project$Page$Search$viewMods(mods);
				case 'Failure':
					return A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
						...
						$mdgriffith$elm_ui$Element$text('I couldn\'t load any mods! Are you offline?'));
				default:
...
var $author$project$Page$Search$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				A2($mdgriffith$elm_ui$Element$Lazy$lazy, $author$project$Page$Search$viewSearchInput, model.searchTerm),
				A2($mdgriffith$elm_ui$Element$Lazy$lazy, $author$project$Page$Search$viewContent, model.results)
			]));
};
